...
/**
 * Playwright configuration file for setting up tests with Allure reporting.
 */
export default defineConfig({
  ...
  /* Opt out of parallel tests on CI */
  workers: process.env.CI ? 1 : undefined,
  /* Reporter to use, including Allure and others */
  reporter: [
    ['html'], // HTML reporter
    ['list'], // List reporter for simple output
  ...
  projects: [
    {
      name: 'chromium', // Project for Chromium (Desktop Chrome)
      use: { ...devices['Desktop Chrome'] },
    },
    {
      name: 'firefox', // Project for Firefox (Desktop Firefox)
      use: { ...devices['Desktop Firefox'] },
    },
    {
      name: 'webkit', // Project for WebKit (Desktop Safari)
      use: { ...devices['Desktop Safari'] },
    },
  ],
